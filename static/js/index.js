...
function create_like(success_cb, error_cb) {
    var post_pk = $(this).siblings('.hidden-data').find('.post-pk').text(); // 去除当前like的post的primary key
    console.log(post_pk);
...
$('.submit-like').on('click', function() { // 通过submit-like这个class找到所有的attribute，当click之后，调用function
